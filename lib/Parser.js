    ...
    return Object.keys(this.fields).reduce((found, key) => {
      ...
      if (field.name === name && field.hasOwnProperty('path')) {
        ...
        if (field.hasOwnProperty('unitId')) {
          ...
          if (field.unitId === 'bmv' && this.options.hasOwnProperty('bmv')) {
            unitID = this.options.vedirect[items].bmv
          }
          ...
          if (typeof field.path !== 'function') {
            found = field.path.replace('*', unitID)
          } else if (!this.options.vedirect[items].hasOwnProperty('bmv') && this.options.vedirect[items].hasOwnProperty('solar')) {
            found = field.path(this.options.vedirect[items].solar, 'solar')
          } else {
            found = field.path(unitID, 'batteries')
          }
        }
      }
      return found
