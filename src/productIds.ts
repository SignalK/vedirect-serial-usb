/**
 * Victron product ID (PID) to human-readable model name.
 *
 * Kept as a TypeScript module rather than a JSON asset so that `tsc` emits
 * it into `dist/` like any other source file (tsc does not copy `.json`
 * files to the output directory).
 */
export const productIds: Record<string, string> = {
  '0x203': 'BMV-700',
  '0x204': 'BMV-702',
  '0x205': 'BMV-700H',
  ...
  '0xA345': 'Phoenix Smart Charger 12V 30A 3 rev2',
