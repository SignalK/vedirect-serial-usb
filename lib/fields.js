...
module.exports = {
  ...
  IL: {
    name: 'loadCurrent',
    path: 'electrical.batteries.*.loadCurrent',
    unitId: 'mainBatt',
    value: common.mA,
    units: 'A',
    type: 'metric'
  ...
  LOAD: {
    ...
    path: 'electrical.batteries.*.load',
    unitId: 'mainBatt',
    type: 'text',
    value (value) {
  ...
  CS: {
    ...
    path: 'electrical.batteries.*.capacity.stateOfOperation',
    unitId: 'mainBatt',
    type: 'text',
    value (value, instance) {
  ...
  MPPT: {
    ...
    path: 'electrical.batteries.*.trackerOperationMode',
    unitId: 'solar',
    type: 'text',
    value (value, instance) {
