...
module.exports = {
  V: {
    ...
    path (unitId, kind) {
      return `electrical.${kind}.${unitId}.voltage`
    },
    unitId: 'mainBatt',
    value: common.mV,
    units: 'V',
  ...
  PPV: {
    ...
    value (value, instance) {
      ...
      if (typeof value !== 'number' || !instance.data.hasOwnProperty('panelVoltage')) {
        return null
      }
      voltage = instance.data.panelVoltage.value
      if (voltage == 0) {
        return 0
      }
  ...
  I: {
    name: 'batteryCurrent',
    path (unitId, kind) {
      return `electrical.${kind}.${unitId}.current`
    },
    unitId: 'mainBatt',
    value: common.mA,
    units: 'A',
